                ...
                return [
                    ...
                    },
                    {
                        ...
                        "rules": ["STATUS-BLEED", "STATUS-BLINDED", "STATUS-CONFUSED", "STATUS-DAZED", "STATUS-DAZZLED",
                            "STATUS-DEAFENED", "STATUS-DYING", "STATUS-ENTANGLED", "STATUS-EXHAUSTED",
                            "STATUS-FATIGUED", "STATUS-FLAT-FOOTED", "STATUS-FRIGHTENED", "STATUS-HELPLESS",
                            "STATUS-INCORPOREAL", "STATUS-INVISIBLE", "STATUS-NAUSEATED", "STATUS-PANICKED",
                            "STATUS-PARALYZED", "STATUS-PETRIFIED", "STATUS-PRONE", "STATUS-SHAKEN", "STATUS-SICKENED",
                            "STATUS-STABLE", "STATUS-STAGGERED", "STATUS-STUNNED", "STATUS-UNCONSCIOUS"]
                    }
                ];
            } else {
                return [
